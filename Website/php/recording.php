...
#s{
  ...
  <body id="page-top">
    <?php
    header("Refresh: 30;url='recording.php'");
    include('session.php');
    ?>
    <header class="masthead">
      <div class="container">
        <h2 id="top" class="section-heading text-uppercase">Recordings</h2>
    ...
    <td bgcolor="#FFFFFF"><?php $files = glob("../webcam/*.jpg*");
    ...
    <ul>
  <?php>  '<li class="image"> <img src="../webcam/Output.png" alt="Image" /></input></li>;'?></ul>
    <!-- Navigation -->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li id="head" class="nav-item">
              <b id="logout"><a class="nav-link js-scroll-trigger" href="logout.php">Log Out</a></b>
            </li>
            <li id="head" class="nav-item">
              <a class="nav-link js-scroll-trigger" href="profile.php">Services</a></b>
            </li>
          </ul>
        </div>
      </div>
