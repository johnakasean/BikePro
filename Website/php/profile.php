  ...
  <body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
          ...
          <h2 id="top" class="section-heading text-uppercase">Services</h2>
        ...
        <div class="container">
          <div class="row text-center">
            ...
            <a href="recording.php">
              ...
              <h4 class="service-heading">Recordings</h4>
            </div>
            <div class="col-md-4">
              <span class="fa-stack fa-4x">
                <i class="fa fa-circle fa-stack-2x text-primary"></i>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Bike Pro</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            <li class="nav-item">
              <b id="logout"><a class="nav-link js-scroll-trigger" href="logout.php">Log Out</a></b>
            </li>
          </ul>
        </div>
      </div>
